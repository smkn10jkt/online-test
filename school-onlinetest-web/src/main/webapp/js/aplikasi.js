angular.module('belajar', ['ui', 'belajar.controller'])
    .config(['$routeProvider', function($routeProvider){
        $routeProvider
            ...
            .when('/master/guru', {templateUrl: 'pages/master/guru.html'})
            .when('/master/mapel', {templateUrl: 'pages/master/mapel.html'})
            .when('/master/siswa', {templateUrl: 'pages/master/siswa.html'})
            .when('/master/jurusan', {templateUrl: 'pages/master/jurusan.html'})
            .when('/master/kelas', {templateUrl: 'pages/master/kelas.html'})
