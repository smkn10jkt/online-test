angular.module('belajar', ['ui', 'belajar.controller'])
    .config(['$routeProvider', function($routeProvider){
	    ...
	    .when('/notifications/email', {templateUrl: 'pages/notifications/email.html'})
            .when('/laporan/lapPeserta', {templateUrl: 'pages/laporan/lapPeserta.html', controller: 'PesertaController'})
            .when('/laporan/lapSoal', {templateUrl: 'pages/laporan/lapSoal.html', controller: 'SoalController'})
            .when('/laporan/lapUjian', {templateUrl: 'pages/laporan/lapUjian.html', controller: 'UjianController'})
            .when('/laporan/lapTopik', {templateUrl: 'pages/laporan/lapTopik.html', controller: 'TopikController'})
            .when('/laporan/lapPertanyaan', {templateUrl: 'pages/laporan/lapPertanyaan.html', controller: 'PertanyaanController'})
            .when('/laporan/lapPilihan', {templateUrl: 'pages/laporan/lapPilihan.html', controller: 'PilihanController'})
            .when('/laporan/school', {templateUrl: 'pages/laporan/school.html'})
            .when('/master/peserta', {templateUrl: 'pages/master/peserta.html', controller: 'PesertaController'})
            ...
            .when('/master/pertanyaan', {templateUrl: 'pages/master/pertanyaan.html', controller: 'PertanyaanController' })
            .when('/master/pilihan', {templateUrl: 'pages/master/pilihan.html', controller: 'PilihanController'})
            .when('/about', {templateUrl: 'pages/about.html', controller: 'AboutControllerr'})
