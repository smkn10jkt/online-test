angular.module('belajar.controller',['belajar.service'])
    ...
    .controller('SoalController', ['$scope', 'SoalService', 'TopikService', function($scope, SoalService, TopikService){
    ...
    .controller('TopikController', ['$scope', 'TopikService', 'SoalService', function($scope, TopikService){
        $scope.topiks = TopikService.query();
        $scope.edit = function(x){
            if(x.id == null){
                return; 
